...
export const DateFilter = ({ confirm, clearFilters, selectedKeys, setSelectedKeys }: { confirm: any, clearFilters: any, selectedKeys: any, setSelectedKeys: any }) => {
    return <div style={{ padding: 8 }}>
        <DatePicker
            ...
            onChange={e => e ? setSelectedKeys([FilterTypesEnum.Between, e.startOf("day").toDate(), selectedKeys[2]]) : undefined}
            style={{ marginBottom: 8, display: 'block' }}
        />
        <DatePicker
            placeholder={`Hasta`}
            ...
            onChange={e => e ? setSelectedKeys([FilterTypesEnum.Between, selectedKeys[1], e.endOf("day").toDate()]) : undefined}
            style={{ marginBottom: 8, display: 'block' }}
        />

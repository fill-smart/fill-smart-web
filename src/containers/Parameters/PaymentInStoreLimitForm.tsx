...
const PaymentInStoreLimitFormFields = forwardRef<
    FormComponentProps,
...
>(({ form, onSubmit, initialValue }, ref) => {
    ...
    return (
        <Form onSubmit={handleSubmit}>
            <FormItem
                {...formItemLayout}
                label="Límite de litros permitidos en Pago en Shop"
                hasFeedback
            >
...
const PaymentInStoreLimitForm = Form.create<FormProps<Partial<IParameterModel>>>()(
    PaymentInStoreLimitFormFields
);
export default PaymentInStoreLimitForm;

...
const GracePeriodFormFields = forwardRef<
    FormComponentProps,
...
>(({ form, onSubmit, initialValue }, ref) => {
    ...
    return (
        <Form onSubmit={handleSubmit}>
            <FormItem
                {...formItemLayout}
                label="Periodo de gracia (dias corridos)"
                hasFeedback
            >
...
const GracePeriodForm = Form.create<FormProps<Partial<IParameterModel>>>()(
    GracePeriodFormFields
);

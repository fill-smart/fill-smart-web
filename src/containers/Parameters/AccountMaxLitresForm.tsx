...
const AccountMaxLitresFormFields = forwardRef<
    FormComponentProps,
...
>(({ form, onSubmit, initialValue }, ref) => {
    ...
    return (
        <Form onSubmit={handleSubmit}>
            <FormItem
                {...formItemLayout}
                label="Limite de litros por cuenta"
                hasFeedback
            >
...
const AccountMaxLitresForm = Form.create<FormProps<Partial<IParameterModel>>>()(
    AccountMaxLitresFormFields
);
export default AccountMaxLitresForm;

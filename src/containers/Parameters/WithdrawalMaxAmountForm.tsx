...
const WithdrawalMaxAmountFormFields = forwardRef<
    FormComponentProps,
...
>(({ form, onSubmit, initialValue }, ref) => {
    ...
    return (
        <Form onSubmit={handleSubmit}>
            <FormItem
                {...formItemLayout}
                label="Límite de efectivo permitido para retirar"
                hasFeedback
            >
...
const WithdrawalMaxAmountForm = Form.create<FormProps<Partial<IParameterModel>>>()(
    WithdrawalMaxAmountFormFields
);
export default WithdrawalMaxAmountForm;

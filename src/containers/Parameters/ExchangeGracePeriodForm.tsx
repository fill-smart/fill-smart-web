...
const ExchangeGracePeriodFormFields = forwardRef<
    FormComponentProps,
...
>(({ form, onSubmit, initialValue }, ref) => {
    ...
    return (
        <Form onSubmit={handleSubmit}>
            <FormItem
                {...formItemLayout}
                label="Periodo de gracia de transferencia entre billeteras (dias corridos)"
                hasFeedback
            >
...
const ExchangeGracePeriodForm = Form.create<FormProps<Partial<IParameterModel>>>()(
    ExchangeGracePeriodFormFields
);
export default ExchangeGracePeriodForm;

...
const WalletMaxLitresFormFields = forwardRef<
    FormComponentProps,
...
>(({ form, onSubmit, initialValue }, ref) => {
    ...
    return (
        <Form onSubmit={handleSubmit}>
            <FormItem
                {...formItemLayout}
                label="Limite de litros por billetera"
                hasFeedback
            >
...
const WalletMaxLitresForm = Form.create<FormProps<Partial<IParameterModel>>>()(
    WalletMaxLitresFormFields
);
export default WalletMaxLitresForm;
